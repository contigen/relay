      ...
      <div className='lg:col-span-4 space-y-6'>
        ...
        <div className='space-y-5 font-mono text-xs text-[#525252]'>
          <div>
            ...
            <p className='leading-relaxed'>
              Tell Relay what service or vendor you are looking for. It uses
              Firecrawl to discover matching vendors and their verified contact
              inboxes.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='leading-relaxed'>
              Define your price ceiling or timeline. Relay filters out
              misaligned providers and pushes for quotes that fit your
              requirements.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='leading-relaxed'>
              Relay acts autonomously for inquiry, initial follow-ups, and quote
              collation. If an ambiguous pricing choice arises, it asks you
              directly.
            </p>
          </div>
        </div>
        ...
        <div className='pt-6 border-t border-[#e5e5e5]'>
          ...
          <div className='space-y-2 font-mono text-xs'>
            ...
            >
              &quot;Find me 3 office cleaning services in Austin, weekly
              contract, under $500/month&quot;
            </button>
            <button
              onClick={() =>
                handleCreatePreview(
              ...
              className='w-full text-left p-2.5 border border-[#e5e5e5] bg-white hover:border-[#0a0a0a] text-[#525252] hover:text-[#0a0a0a] transition-colors'
            >
              &quot;Get quotes from 3 caterers in NYC for a 40-person lunch,
              budget $1,200&quot;
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className='space-y-4 font-mono text-xs'>
            <div className='bg-[#f5f5f5] p-4 text-[#171717] max-w-xl leading-relaxed'>
              Hi! I&apos;m Relay Sourcing Agent. Describe the services you need
              quoted, your target location, budget limits, and timeline.
              I&apos;ll parse the intent and coordinate quotes across multiple
              vendors.
            </div>
            ...
            {plan && (
              <div className='border border-[#e5e5e5] p-5 bg-[#fafafa] max-w-lg mt-4 space-y-3'>
                ...
                <div className='space-y-2 text-xs text-[#525252] border-t border-[#e5e5e5] pt-2.5'>
                  <div>
                    <span className='text-[#8a8a8a] block text-[10px] uppercase'>
                      Task Requirements:
                    </span>
                    <p className='text-[#0a0a0a] font-mono mt-0.5 leading-relaxed'>
                      {plan.task}
                    </p>
                  </div>
